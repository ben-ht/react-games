...
describe('GameCarousel', () => {
    ...
    it ('It changes the active slide when clicking on a thumbnail', () => {
        ...
        const firstThumbnail = result.container.querySelectorAll('.game-screenshot-preview-container img')[0];
        fireEvent.click(firstThumbnail);
        assert(activeSlide.id == firstThumbnail.id);

        const lastThumbnail = result.container.querySelectorAll('.game-screenshot-preview-container img')[2];
